...
<RiCurrencyLine className="text-white text-3xl hover:animate-spin"/>
      ...
      <div className=" hidden md:flex items-center gap-4">
       {links.map((link,index)=>{
        ...
        return(
          <div key={index} className={`${index === selected ? "bg-black dark:bg-slate-800 text-white" : " text-gray-700 dark:text-gray-500"} px-6 py-2 rounded-full`}
      ...
      <div className="flex items-center gap-10 2xl:gap-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className=" hidden md:block">
            <p className="text-lg font-medium text-black dark:text-gray-400">Tejendra</p>
            <span className="text-sm text-gray-700 dark:text-gray-500">tejendrasinh44@gmail.com</span>
          </div>
